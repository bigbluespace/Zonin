...
- (void)viewDidLoad {
    ...
    titleList = [[NSMutableArray alloc] initWithArray: @[@"Home", @"Hot News",@"Add Incident", @"Add Review", @"Incidents & Reviews", @"Login", @"Search",@"Forum", @"About", @"Settings"]];
    
    imageList = [[NSMutableArray alloc] initWithArray: @[@"zonin_logo_final-1", @"hot_news", @"report_crime", @"review_officer",@"reviews_reports",@"login",@"search",@"forum",@"about",@"settings"]];
    
//    CGRect frame = _tableView.tableHeaderView.frame;
//    frame.size.height = IPAD ? 250 : 144;
//     [_tableView.tableHeaderView setFrame:frame];
